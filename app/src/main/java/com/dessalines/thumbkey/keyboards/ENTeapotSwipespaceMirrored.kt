...
val KB_EN_TEAPOT_SWIPESPACE_MIRROR_NUMERIC =
    KeyboardC(
        listOf(
            listOf(
                KeyItemC(
                    center = KeyC((1 shl 10) or (1 shl 7), "0", size=LARGE),
                ),
                KeyItemC(
                    center = KeyC((1 shl 10) or (1 shl 6), "1", size=LARGE),
                ),
                KeyItemC(
                    center = KeyC((1 shl 10) or (1 shl 5), "2", size=LARGE),
                ),
                KeyItemC(
            ...
            listOf(
                ...
                KeyItemC(
                    center = KeyC((1 shl 10) or (1 shl 2), "4", size=LARGE),
                ),
                KeyItemC(
                    center = KeyC((1 shl 10) or (1 shl 1), "5", size=LARGE),
                ),
                KeyItemC(
